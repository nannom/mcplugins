...
#공격시
execute as @e[tag=click] on attacker at @e[tag=attack] if score @s attack_cooldown matches ..0 run function skul:file2
...
execute as @e[tag=click] on target run function skul:file4
